 ...
 */
public class MonPlanningActivity extends Activity {
    ...
    public class MyDrawerItemClickListener implements ListView.OnItemClickListener{
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            switch(position) {
                case 0:
                    startActivity(new Intent(MonPlanningActivity.this, AccueilActivity.class));
                    break;
                case 1:
                    startActivity(new Intent(MonPlanningActivity.this, ServicesActivity.class));
                    break;
                case 2:
                    startActivity(new Intent(MonPlanningActivity.this, PlanningActivity.class));
                    break;
                case 3:
                    startActivity(new Intent(MonPlanningActivity.this, MapActivity.class));
                    break;
                case 4:
                    startActivity(new Intent(MonPlanningActivity.this, SpectacleActivity.class));
                    break;
                case 5:
                    startActivity(new Intent(MonPlanningActivity.this, PartageActivity.class));
                    break;
            }
        }
    }
